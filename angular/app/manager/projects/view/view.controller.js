...
angular
    .module('app')
    .controller('ManagerProjectViewController', ManagerProjectViewController);

ManagerProjectViewController.$inject = ['$stateParams', 'Page', 'Auth', 'Project', 'User', 'Flash'];

function ManagerProjectViewController($stateParams, Page, Auth, Project, User, Flash) {
    let vm = this;
