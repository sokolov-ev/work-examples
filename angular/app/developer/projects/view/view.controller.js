...
angular
    .module('app')
    .controller('DeveloperProjectViewController', DeveloperProjectViewController);

DeveloperProjectViewController.$inject = ['$stateParams', 'Statistics', 'Auth', 'Page'];

function DeveloperProjectViewController($stateParams, Statistics, Auth, Page) {
    let vm = this;
