...
angular
    .module('app')
    .controller('AdminProjectViewController', AdminProjectViewController);

AdminProjectViewController.$inject = ['$stateParams', 'Page', 'Project', 'User', 'Flash'];

function AdminProjectViewController($stateParams, Page, Project, User, Flash) {
    let vm = this;
