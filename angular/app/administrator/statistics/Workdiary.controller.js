(function(){
    ...
    angular
        .module('app')
        .controller('AdminWorkdiary', AdminWorkdiary);

    AdminWorkdiary.$inject = ['Page', 'User', 'Statistics', '$stateParams', '$state'];

    function AdminWorkdiary(Page, User, Statistics, $stateParams, $state) {
        let vm = this;
        ...
        function getDay() {
            ...
            $state.go('admin.workdiary', {id: vm.developer.id, day: moment(new Date(toDayTime)).format('YYYY-MM-DD')}, {notify: false});
