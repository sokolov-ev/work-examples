...
angular
    .module('app')
    .controller('ManagerUserProjects', ManagerUserProjects);

ManagerUserProjects.$inject = ['Page', 'User', '$stateParams', 'Project'];

function ManagerUserProjects(Page, User, $stateParams, Project) {
    let vm = this;
